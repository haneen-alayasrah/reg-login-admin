...
if (isset($_POST['user_save'])) {
	...
	$sql="INSERT INTO users (username ,email, password ,department_id)  VALUES ('$username' , '$email' , '$password','$department_name' )";
...
{  
	...
	$query ="UPDATE users SET  username='$username' , email= '$email' , password= '$password' , department_id='$department_name' WHERE userid= '$id' " ;
